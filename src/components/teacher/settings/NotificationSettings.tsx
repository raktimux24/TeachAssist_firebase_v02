            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <button
                  type="button"
                  role="switch"
                  aria-checked={notifications.newComments}
                  onClick={() => handleToggle('newComments')}
                  className={`
                    relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent
                    transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500
                    ${notifications.newComments ? 'bg-primary-600' : 'bg-gray-200'}
                  `}
                >
                  <span
                    aria-hidden="true"
                    className={`
                      pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow
                      ring-0 transition duration-200 ease-in-out
                      ${notifications.newComments ? 'translate-x-5' : 'translate-x-0'}
                    `}
                  />
                </button>
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  type="button"
                  role="switch"
                  aria-checked={notifications.lessonPlanUpdates}
                  onClick={() => handleToggle('lessonPlanUpdates')}
                  className={`
                    relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent
                    transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500
                    ${notifications.lessonPlanUpdates ? 'bg-primary-600' : 'bg-gray-200'}
                  `}
                >
                  <span
                    aria-hidden="true"
                    className={`
                      pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow
                      ring-0 transition duration-200 ease-in-out
                      ${notifications.lessonPlanUpdates ? 'translate-x-5' : 'translate-x-0'}
                    `}
                  />
                </button>
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  type="button"
                  role="switch"
                  aria-checked={notifications.resourceSharing}
                  onClick={() => handleToggle('resourceSharing')}
                  className={`
                    relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent
                    transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500
                    ${notifications.resourceSharing ? 'bg-primary-600' : 'bg-gray-200'}
                  `}
                >
                  <span
                    aria-hidden="true"
                    className={`
                      pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow
                      ring-0 transition duration-200 ease-in-out
                      ${notifications.resourceSharing ? 'translate-x-5' : 'translate-x-0'}
                    `}
                  />
                </button>
              </div>
