...
export default function AdminHeader({ onMenuClick, isDarkMode, onThemeToggle }: AdminHeaderProps) {
          ...
          <div className="flex items-center">
            ...
            <h1 className="text-xl sm:text-2xl font-semibold text-gray-900 dark:text-white truncate">
              {location.pathname === '/admin' ? 'Admin Dashboard' :
               ...
               location.pathname === '/admin/resources' ? 'Resource Library' :
               location.pathname === '/admin/logs' ? 'Activity Logs' :
               location.pathname === '/admin/settings' ? 'Settings' :
               location.pathname === '/admin/users/add' ? 'Add User' :
               location.pathname === '/admin/resources/upload' ? 'Upload Resources' :
               'Admin Panel'}
            </h1>
          </div>
